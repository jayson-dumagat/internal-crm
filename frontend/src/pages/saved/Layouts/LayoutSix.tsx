...
import SidebarSix from "../../../components/example-layout/example-sidebar/sidebar-six";
import Backdrop from "../../../layout/Backdrop";

const LayoutSixContent: React.FC = () => {
...
export default function LayoutSix() {
  return (
    <>
      <PageMeta
        title="React.js Layout Six Dashboard | TailAdmin - React.js Admin Dashboard Template"
        description="This is React.js Layout Six Dashboard page for TailAdmin - React.js Tailwind CSS Admin Dashboard Template"
      />
      <SidebarProvider>
        <LayoutSixContent />
      </SidebarProvider>
