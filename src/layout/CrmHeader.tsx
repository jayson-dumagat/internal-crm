    ...
    <header className="sticky top-0 z-99999 flex w-full border-gray-200 bg-white xl:border-b dark:border-gray-800 dark:bg-gray-900">
      <div className="flex grow flex-col items-center justify-between xl:flex-row xl:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:py-4 xl:justify-normal xl:border-b-0 xl:px-0 dark:border-gray-800">
          ...
          <Link to="/" className="inline-flex items-center gap-2 xl:hidden">
            <img
            ...
            <div className="flex w-[134px] flex-col leading-none">
              <span className="font-['Avenir_Next_LT_Pro','Avenir_Next',Arial,sans-serif] text-sm font-semibold tracking-[0.15em] whitespace-nowrap text-[#104862] dark:text-white">
                CABALLES-GO
              </span>

              <span className="my-0.5 h-[1.5px] w-full bg-[#104862] dark:bg-white" />

              <span className="font-['Avenir_Next_LT_Pro','Avenir_Next',Arial,sans-serif] text-[10px] font-bold tracking-[0.58em] whitespace-nowrap text-[#104862] dark:text-white">
                SECURITIES
              </span>
            </div>
          </Link>
